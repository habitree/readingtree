          ...
          headers: [
            ...securityHeaders,
            {
              ...
              value: [
                ...
                "connect-src 'self' https://*.supabase.co https://*.kakao.com https://*.googleapis.com wss://*.supabase.co ws://localhost:* https://*.tosspayments.com",
        ...
        headers: [
          ...securityHeaders,
          {
            ...
            value: [
              ...
              "img-src 'self' data: https: blob:",
              "font-src 'self' data: https://fonts.gstatic.com",
              "connect-src 'self' https://*.supabase.co https://*.kakao.com https://*.googleapis.com https://*.google-analytics.com wss://*.supabase.co https://*.tosspayments.com",
              "frame-src 'self' https://*.supabase.co https://*.kakao.com https://accounts.google.com https://*.tosspayments.com",
              "object-src 'none'",
              "base-uri 'self'",
