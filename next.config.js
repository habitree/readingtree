          ...
          headers: [
            ...securityHeaders,
            {
              ...
              value: [
                ...
                "connect-src 'self' https://*.supabase.co https://*.kakao.com https://*.googleapis.com wss://*.supabase.co ws://localhost:* https://*.tosspayments.com https://archive.org",
        ...
        headers: [
          ...securityHeaders,
          {
            ...
            value: [
              ...
              "font-src 'self' data: https://fonts.gstatic.com",
              "media-src 'self' https://archive.org",
              "connect-src 'self' https://*.supabase.co https://*.kakao.com https://*.googleapis.com https://*.google-analytics.com wss://*.supabase.co https://*.tosspayments.com https://archive.org",
              "frame-src 'self' https://*.supabase.co https://*.kakao.com https://accounts.google.com https://*.tosspayments.com",
              "object-src 'none'",
              "base-uri 'self'",
