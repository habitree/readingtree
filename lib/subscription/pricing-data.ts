...
const _FEATURE_INFO_ROWS: FeatureInfoRow[] = [
  ...
  { key: "notes_create", label: "노트 작성", freeLimit: "100개/월", readerLimit: "무제한", masterLimit: "무제한", pointCost: "10P/개" },
  { key: "groups_create", label: "모임 생성", freeLimit: "포인트 전용", readerLimit: "5개", masterLimit: "무제한", pointCost: "300P/개" },
  { key: "groups_join", label: "모임 참여", freeLimit: "5개", readerLimit: "무제한", masterLimit: "무제한", pointCost: "200P/개" },
  { key: "bookshelf_create", label: "책장 생성", freeLimit: "2개", readerLimit: "무제한", masterLimit: "무제한", pointCost: "150P/개" },
