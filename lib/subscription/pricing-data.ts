...
const _FEATURE_INFO_ROWS: FeatureInfoRow[] = [
  ...
  { key: "notes_create", label: "노트 작성", freeLimit: "20개/월", readerLimit: "무제한", masterLimit: "무제한", pointCost: "10P/개" },
  { key: "groups_create", label: "모임 생성", freeLimit: "포인트 전용", readerLimit: "5개", masterLimit: "무제한", pointCost: "300P/개" },
  { key: "groups_join", label: "모임 참여", freeLimit: "3개", readerLimit: "무제한", masterLimit: "무제한", pointCost: "200P/개" },
